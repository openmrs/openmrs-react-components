...
export const DEFAULT_ENCOUNTER_REP = '(id,uuid,encounterDatetime,location:(id,uuid,name),encounterType:(id,uuid,name),obs:(id,uuid,value,concept:(uuid,display,name,datatype,conceptClass,set,retired,names,descriptions,mappings,answers,setMembers,units),comment,display,groupMembers:(id,uuid,value,concept:(uuid,display,name,datatype,conceptClass,set,retired,names,descriptions,mappings,answers,setMembers,units),comment,display,groupMembers:(id,uuid,value,concept,comment,display,groupMembers)))';
