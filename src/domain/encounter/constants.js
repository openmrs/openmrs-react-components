...
export const DEFAULT_ENCOUNTER_REP = '(id,uuid,encounterDatetime,location:(id,uuid,name),encounterType:(id,uuid,name),obs:(id,uuid,value,concept,comment,display,groupMembers:(id,uuid,value,concept,comment,display,groupMembers:(id,uuid,value,concept,comment,display,groupMembers)))';
